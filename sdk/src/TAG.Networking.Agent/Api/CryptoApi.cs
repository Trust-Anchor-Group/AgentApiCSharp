...
namespace TAG.Networking.Agent.Api
{
    ...
    public partial class CryptoApi : ICryptoApi
    {
        ...
        /// <returns></returns>
        public CryptoApi(TAG.Networking.Agent.Client.Configuration configuration)
        {
        ...
        public CryptoApi(TAG.Networking.Agent.Client.ISynchronousClient client, TAG.Networking.Agent.Client.IAsynchronousClient asyncClient, TAG.Networking.Agent.Client.IReadableConfiguration configuration)
        {
        ...
        {
            TAG.Networking.Agent.Client.ApiResponse<Stored> localVarResponse = CreateKeyWithHttpInfo(createKeyBody);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Stored</returns>
        public TAG.Networking.Agent.Client.ApiResponse<Stored> CreateKeyWithHttpInfo(CreateKeyBody createKeyBody = default(CreateKeyBody), int operationIndex = 0)
        {
        ...
        {
            TAG.Networking.Agent.Client.ApiResponse<Stored> localVarResponse = await CreateKeyWithHttpInfoAsync(createKeyBody, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Stored)</returns>
        public async System.Threading.Tasks.Task<TAG.Networking.Agent.Client.ApiResponse<Stored>> CreateKeyWithHttpInfoAsync(CreateKeyBody createKeyBody = default(CreateKeyBody), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TAG.Networking.Agent.Client.ApiResponse<AlgorithmsResult> localVarResponse = GetAlgorithmsWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AlgorithmsResult</returns>
        public TAG.Networking.Agent.Client.ApiResponse<AlgorithmsResult> GetAlgorithmsWithHttpInfo(Object body = default(Object), int operationIndex = 0)
        {
            TAG.Networking.Agent.Client.RequestOptions localVarRequestOptions = new TAG.Networking.Agent.Client.RequestOptions();
        ...
        {
            TAG.Networking.Agent.Client.ApiResponse<AlgorithmsResult> localVarResponse = await GetAlgorithmsWithHttpInfoAsync(body, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AlgorithmsResult)</returns>
        public async System.Threading.Tasks.Task<TAG.Networking.Agent.Client.ApiResponse<AlgorithmsResult>> GetAlgorithmsWithHttpInfoAsync(Object body = default(Object), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TAG.Networking.Agent.Client.ApiResponse<GetPublicKeyResponse> localVarResponse = GetPublicKeyWithHttpInfo(getPublicKeyBody);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetPublicKeyResponse</returns>
        public TAG.Networking.Agent.Client.ApiResponse<GetPublicKeyResponse> GetPublicKeyWithHttpInfo(GetPublicKeyBody getPublicKeyBody = default(GetPublicKeyBody), int operationIndex = 0)
        {
            TAG.Networking.Agent.Client.RequestOptions localVarRequestOptions = new TAG.Networking.Agent.Client.RequestOptions();
        ...
        {
            TAG.Networking.Agent.Client.ApiResponse<GetPublicKeyResponse> localVarResponse = await GetPublicKeyWithHttpInfoAsync(getPublicKeyBody, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetPublicKeyResponse)</returns>
        public async System.Threading.Tasks.Task<TAG.Networking.Agent.Client.ApiResponse<GetPublicKeyResponse>> GetPublicKeyWithHttpInfoAsync(GetPublicKeyBody getPublicKeyBody = default(GetPublicKeyBody), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
