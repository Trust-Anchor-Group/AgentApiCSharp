...
namespace TAG.Networking.Agent.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InitiateBuyEDalerBody")]
    public partial class InitiateBuyEDalerBody : IEquatable<InitiateBuyEDalerBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateBuyEDalerBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InitiateBuyEDalerBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateBuyEDalerBody" /> class.
        /// </summary>
        ...
        public InitiateBuyEDalerBody(string serviceId = default(string), string serviceProvider = default(string), double amount = default(double), string currency = default(string), string successUrl = default(string), string failureUrl = default(string), string cancelUrl = default(string), string transactionId = default(string), string tabId = default(string))
        {
            ...
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for InitiateBuyEDalerBody and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InitiateBuyEDalerBody {\n");
        ...
        {
            return this.Equals(input as InitiateBuyEDalerBody);
        }

        /// <summary>
        /// Returns true if InitiateBuyEDalerBody instances are equal
        /// </summary>
        /// <param name="input">Instance of InitiateBuyEDalerBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitiateBuyEDalerBody input)
        {
            if (input == null)
            {
                return false;
