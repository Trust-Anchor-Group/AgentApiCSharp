...
namespace Neuron.Agent.Api
{
    ...
    public partial class StateMachinesApi : IStateMachinesApi
    {
        ...
        /// <returns></returns>
        public StateMachinesApi(Neuron.Agent.Client.Configuration configuration)
        {
        ...
        public StateMachinesApi(Neuron.Agent.Client.ISynchronousClient client, Neuron.Agent.Client.IAsynchronousClient asyncClient, Neuron.Agent.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Neuron.Agent.Client.ApiResponse<ReportResult> localVarResponse = CreateReportWithHttpInfo(createReportBody);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ReportResult</returns>
        public Neuron.Agent.Client.ApiResponse<ReportResult> CreateReportWithHttpInfo(CreateReportBody createReportBody = default(CreateReportBody), int operationIndex = 0)
        {
        ...
        {
            Neuron.Agent.Client.ApiResponse<ReportResult> localVarResponse = await CreateReportWithHttpInfoAsync(createReportBody, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ReportResult)</returns>
        public async System.Threading.Tasks.Task<Neuron.Agent.Client.ApiResponse<ReportResult>> CreateReportWithHttpInfoAsync(CreateReportBody createReportBody = default(CreateReportBody), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Neuron.Agent.Client.ApiResponse<StateResult> localVarResponse = GetCurrentStateWithHttpInfo(getCurrentStateBody);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of StateResult</returns>
        public Neuron.Agent.Client.ApiResponse<StateResult> GetCurrentStateWithHttpInfo(GetCurrentStateBody getCurrentStateBody = default(GetCurrentStateBody), int operationIndex = 0)
        {
            Neuron.Agent.Client.RequestOptions localVarRequestOptions = new Neuron.Agent.Client.RequestOptions();
        ...
        {
            Neuron.Agent.Client.ApiResponse<StateResult> localVarResponse = await GetCurrentStateWithHttpInfoAsync(getCurrentStateBody, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StateResult)</returns>
        public async System.Threading.Tasks.Task<Neuron.Agent.Client.ApiResponse<StateResult>> GetCurrentStateWithHttpInfoAsync(GetCurrentStateBody getCurrentStateBody = default(GetCurrentStateBody), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
