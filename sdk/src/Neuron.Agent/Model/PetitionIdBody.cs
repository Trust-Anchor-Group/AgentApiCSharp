...
namespace Neuron.Agent.Model
{
    ...
    /// PetitionIdBody
    /// </summary>
    [DataContract(Name = "PetitionIdBody")]
    public partial class PetitionIdBody : IEquatable<PetitionIdBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PetitionIdBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PetitionIdBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PetitionIdBody" /> class.
        /// </summary>
        ...
        public PetitionIdBody(string keyId = default(string), string legalId = default(string), string remoteId = default(string), string petitionId = default(string), string purpose = default(string), string keySignature = default(string), string requestSignature = default(string))
        {
            // to ensure "keyId" is required (not null)
            if (keyId == null)
            {
                throw new ArgumentNullException("keyId is a required property for PetitionIdBody and cannot be null");
            }
            this.KeyId = keyId;
            // to ensure "legalId" is required (not null)
            if (legalId == null)
            {
                throw new ArgumentNullException("legalId is a required property for PetitionIdBody and cannot be null");
            }
            this.LegalId = legalId;
            // to ensure "remoteId" is required (not null)
            if (remoteId == null)
            {
                throw new ArgumentNullException("remoteId is a required property for PetitionIdBody and cannot be null");
            }
            this.RemoteId = remoteId;
            // to ensure "petitionId" is required (not null)
            if (petitionId == null)
            {
                throw new ArgumentNullException("petitionId is a required property for PetitionIdBody and cannot be null");
            }
            this.PetitionId = petitionId;
            // to ensure "purpose" is required (not null)
            if (purpose == null)
            {
                throw new ArgumentNullException("purpose is a required property for PetitionIdBody and cannot be null");
            }
            this.Purpose = purpose;
            // to ensure "keySignature" is required (not null)
            if (keySignature == null)
            {
                throw new ArgumentNullException("keySignature is a required property for PetitionIdBody and cannot be null");
            }
            this.KeySignature = keySignature;
            // to ensure "requestSignature" is required (not null)
            if (requestSignature == null)
            {
                throw new ArgumentNullException("requestSignature is a required property for PetitionIdBody and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PetitionIdBody {\n");
        ...
        {
            return this.Equals(input as PetitionIdBody);
        }

        /// <summary>
        /// Returns true if PetitionIdBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PetitionIdBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PetitionIdBody input)
        {
            if (input == null)
            {
                return false;
