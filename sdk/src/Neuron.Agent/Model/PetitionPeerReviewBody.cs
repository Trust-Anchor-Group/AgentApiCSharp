...
namespace Neuron.Agent.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PetitionPeerReviewBody")]
    public partial class PetitionPeerReviewBody : IEquatable<PetitionPeerReviewBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PetitionPeerReviewBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PetitionPeerReviewBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PetitionPeerReviewBody" /> class.
        /// </summary>
        ...
        /// <param name="legalId">Identifier of the Legal Identity that will be used to sign the petition, and that will be reviewed by the peer. (required).</param>
        /// <param name="remoteId">Identifier of the remote legal identity the client requests review the identity application. (required).</param>
        ...
        public PetitionPeerReviewBody(string keyId = default(string), string legalId = default(string), string remoteId = default(string), string petitionId = default(string), string purpose = default(string), string keySignature = default(string), string requestSignature = default(string))
        {
            // to ensure "keyId" is required (not null)
            if (keyId == null)
            {
                throw new ArgumentNullException("keyId is a required property for PetitionPeerReviewBody and cannot be null");
            }
            this.KeyId = keyId;
            // to ensure "legalId" is required (not null)
            if (legalId == null)
            {
                throw new ArgumentNullException("legalId is a required property for PetitionPeerReviewBody and cannot be null");
            }
            this.LegalId = legalId;
            // to ensure "remoteId" is required (not null)
            if (remoteId == null)
            {
                throw new ArgumentNullException("remoteId is a required property for PetitionPeerReviewBody and cannot be null");
            }
            this.RemoteId = remoteId;
            // to ensure "petitionId" is required (not null)
            if (petitionId == null)
            {
                throw new ArgumentNullException("petitionId is a required property for PetitionPeerReviewBody and cannot be null");
            }
            this.PetitionId = petitionId;
            // to ensure "purpose" is required (not null)
            if (purpose == null)
            {
                throw new ArgumentNullException("purpose is a required property for PetitionPeerReviewBody and cannot be null");
            }
            this.Purpose = purpose;
            // to ensure "keySignature" is required (not null)
            if (keySignature == null)
            {
                throw new ArgumentNullException("keySignature is a required property for PetitionPeerReviewBody and cannot be null");
            }
            this.KeySignature = keySignature;
            // to ensure "requestSignature" is required (not null)
            if (requestSignature == null)
            {
                throw new ArgumentNullException("requestSignature is a required property for PetitionPeerReviewBody and cannot be null");
            }
        ...
        /// <summary>
        /// Identifier of the Legal Identity that will be used to sign the petition, and that will be reviewed by the peer.
        /// </summary>
        /// <value>Identifier of the Legal Identity that will be used to sign the petition, and that will be reviewed by the peer.</value>
        [DataMember(Name = "legalId", IsRequired = true, EmitDefaultValue = true)]
        public string LegalId { get; set; }

        /// <summary>
        /// Identifier of the remote legal identity the client requests review the identity application.
        /// </summary>
        /// <value>Identifier of the remote legal identity the client requests review the identity application.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PetitionPeerReviewBody {\n");
        ...
        {
            return this.Equals(input as PetitionPeerReviewBody);
        }

        /// <summary>
        /// Returns true if PetitionPeerReviewBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PetitionPeerReviewBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PetitionPeerReviewBody input)
        {
            if (input == null)
            {
                return false;
