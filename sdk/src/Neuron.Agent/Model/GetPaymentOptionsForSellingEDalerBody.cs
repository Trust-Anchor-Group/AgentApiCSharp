...
namespace Neuron.Agent.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPaymentOptionsForSellingEDalerBody")]
    public partial class GetPaymentOptionsForSellingEDalerBody : IEquatable<GetPaymentOptionsForSellingEDalerBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPaymentOptionsForSellingEDalerBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPaymentOptionsForSellingEDalerBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPaymentOptionsForSellingEDalerBody" /> class.
        /// </summary>
        ...
        public GetPaymentOptionsForSellingEDalerBody(string serviceId = default(string), string serviceProvider = default(string), string successUrl = default(string), string failureUrl = default(string), string cancelUrl = default(string), string transactionId = default(string), string tabId = default(string), string functionName = default(string))
        {
            // to ensure "serviceId" is required (not null)
            if (serviceId == null)
            {
                throw new ArgumentNullException("serviceId is a required property for GetPaymentOptionsForSellingEDalerBody and cannot be null");
            }
            this.ServiceId = serviceId;
            // to ensure "serviceProvider" is required (not null)
            if (serviceProvider == null)
            {
                throw new ArgumentNullException("serviceProvider is a required property for GetPaymentOptionsForSellingEDalerBody and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPaymentOptionsForSellingEDalerBody {\n");
        ...
        {
            return this.Equals(input as GetPaymentOptionsForSellingEDalerBody);
        }

        /// <summary>
        /// Returns true if GetPaymentOptionsForSellingEDalerBody instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPaymentOptionsForSellingEDalerBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPaymentOptionsForSellingEDalerBody input)
        {
            if (input == null)
            {
                return false;
